...
💡 **重点说明：**
- **不需要手动加表头！** 你只需直接把记录复制进去即可。脚本如果检测到没有表头，会**自动**为你插入标准的 29 列字段。
...
3. 🤖机器评分 (Auto Score)
4. 内容类型 (Link Type)
5. 建议策略 (Action Suggested)
6. 竞品重合度 (Alpha)
7. 🔗该域名下总外链 (Total Links)
8. DR权重
9. 页面流量
10. Dofollow
11. Spam
12. 对标链接样例
13. 🧠AI：业务相关性评分 (0-100)
14. 🧠AI：配套内容 (如 Pitch 邮件|大纲)
15. 🧠AI：难度评级 (Easy|Hard)
16. 🧑‍💻联系邮箱 (Email)
17. 🧑‍💻获取入口URL
18. 🏆总分 (Total Score)（自动计算）
19. 🧑‍💻人工：审阅状态
20. 🧑‍💻当前状态 (Status)
21. Last Action Date
22. Link Result
23. 🤝合作模式 (Cooperation Model)
24. 💰合作报价 (Cost/Price)
25. ✍️内容提供方 (Content Provider)
26. 📍发布板块与位置 (Placement)
27. ⏳链接留存期 (Link Duration)
28. 🔗约定链接属性 (Agreed Attribute)
29. 身份

### 3. 设置邮件模板 (Templates)
编辑 `templates/template_01.txt` 文件：
- **第一行**：脚本会默认将其提取为**邮件主题 (Subject)**。
- **剩余内容**：将被视为**邮件正文 (Body)**。
